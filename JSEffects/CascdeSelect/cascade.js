...
function cascdeInit(v1,v2,v3) {
    //打开xlmdocm文档
	xmlDoc = loadXmlFile('./Area.xml'); //这种方式不能在本地运行，否则报错：Cross origin requests are only supported for protocol schemes: http, data, chrome-extension, https, chrome-extension-resource.
